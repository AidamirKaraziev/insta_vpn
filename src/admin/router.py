...
"""Celery"""
# TODO отключение неоплаченных профилей
# TODO CELERY сделать рассылку сообщений пользователям


"""Реферальная программа"""
# TODO Написать блок схему
...
# TODO добавить поле в аккаунт trial, referral
# TODO надо ли ограничить количество создаваемых профилей? думаю да чтобы ебланы и ебланнесы не создавали по
#  2000 неоплаченных профилей      ОГРАНИЧИТЬ до 5
