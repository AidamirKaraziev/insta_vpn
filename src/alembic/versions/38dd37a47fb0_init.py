...
Revision ID: 38dd37a47fb0
Revises: 
Create Date: 2023-09-05 19:07:44.354111
...
def upgrade() -> None:
    ...
    sa.Column('user_bytes', sa.Integer(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('account_id', 'server_id', 'access_url', name='_account_server_access_url_uc')
    )
