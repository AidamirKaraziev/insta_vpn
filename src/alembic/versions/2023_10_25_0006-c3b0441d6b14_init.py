...
Revision ID: c3b0441d6b14
Revises: 
Create Date: 2023-10-25 00:06:25.609400
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("static_key_id", sa.BigInteger(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["static_key_id"], ["static_key.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("dynamic_key"),
        sa.UniqueConstraint("static_key_id"),
    )
    op.create_table(
        "user",
        sa.Column("id", sa.Integer(), nullable=False),
